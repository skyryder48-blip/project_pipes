...
description 'Colt King Cobra Snub .357 Magnum - 2" Barrel - Concealment Trade-offs'
version '1.0.0'
...
-- Meta files
files {
    'meta/weapon_kingcobra_snub.meta',
...
data_file 'WEAPONINFO_FILE' 'meta/weapon_kingcobra_snub.meta'
